...
public class AliPay implements Pay {
     ...
     * @param payInfo 支付信息
     */
    private String getOrderInfo(PayInfo payInfo) {
        // 签约合作者身份ID
        ...
        // 商户网站唯一订单号
        orderInfo += "&out_trade_no=" + "\"" + payInfo.getTraceNo() + "\"";
        ...
        // 服务器异步通知页面路径
        orderInfo += "&notify_url=" + "\"" + PayConfig.NOTIFY_URL
                + "\"";
